(function (f) { if (typeof exports === "object" && typeof module !== "undefined") { module.exports = f() } else if (typeof define === "function" && define.amd) { define([], f) } else { var g; if (typeof window !== "undefined") { g = window } else if (typeof global !== "undefined") { g = global } else if (typeof self !== "undefined") { g = self } else { g = this } g.storeapi = f() } })(function () {
    ...
    1: [function (require, module, exports) {
      ...
      var Client = function () {
        function Client() {
          ...
          this.decoders = options.decoders || [new codecs.storeJSONCodec(), new codecs.JSONCodec(), new codecs.TextCodec()];
      ...
      var storeJSONCodec = function () {
        function storeJSONCodec() {
          _classCallCheck(this, storeJSONCodec);

          this.mediaType = 'application/storeapi+json';
        }

        _createClass(storeJSONCodec, [{
          key: 'decode',
        ...
        return storeJSONCodec;
      }();

      module.exports = {
        storeJSONCodec: storeJSONCodec
      };

    }, { "../document": 10, "url-parse": 19 }], 7: [function (require, module, exports) {
      'use strict';

      var storejson = require('./storejson');
      var json = require('./json');
      var text = require('./text');

      module.exports = {
        storeJSONCodec: storejson.storeJSONCodec,
        JSONCodec: json.JSONCodec,
        TextCodec: text.TextCodec
      };

    }, { "./storejson": 6, "./json": 8, "./text": 9 }], 8: [function (require, module, exports) {
      'use strict';
